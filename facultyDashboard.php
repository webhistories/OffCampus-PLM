...
<html lang="en">
    ...
    <body style="padding-top: 80px">
            ...
            <!-- Brand and toggle get grouped for better mobile display -->
		        ...
		        <!-- <li class="dropdown">
		          			...
		          			<ul class="dropdown-menu">
					            <li><a href="studRecords.php">Student Records</a></li>
					            <li><a href="facLoading.php">Faculty Loading</a></li>
		         			</ul>
		        		</li> -->

                        <li>
                            <a href="report2/home.html" role="button" aria-haspopup="true" aria-expanded="false">Reports</a>
                            </li>
                        ...
                        <li class="dropdown">
		          			...
		          			<ul class="dropdown-menu">
					            <!--<li><a href="facMgmt.php">Faculty Management</a></li> -->

                                   <li><a href="add_form.php">Create Schedule</a></li>
					            <li><a href="scheduling.php">View/Edit Schedules</a></li>
                                <li><a href="#">Subject Maintenance</a></li>
		         			</ul>
		        		</li>

		        		<!--class="dropdown">
			          		<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Evaluate <span class="caret"></span></a>
		          			<ul class="dropdown-menu">
					            <li><a href="evalEnrollees.php">Enrollees</a></li>
					            <li><a href="evalApplicants.php">Applicants</a></li>
		         			</ul>
		        		</li> -->
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top hidden" id="subNav">
            <div class="container-fluid">
            <!-- Brand and toggle get grouped for better mobile display -->
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="egrades.php"> E Grades</a></li>
    ...
    <script>
        ...
        $("#saveChangePassword").click(function(){
            ...
            var newPassword = $("#newPassword").val(), //input text id
                confirmPassword = $("#confirmPassword").val(), //inulit
